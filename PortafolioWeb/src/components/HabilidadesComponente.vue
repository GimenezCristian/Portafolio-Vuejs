...
const habilidades = ref([
    ...
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            ...
            { id: 4, nombre: 'Django', nivel: 'Avanzado', icono: img9 },
...
.skills-contenedor {
    padding: 3rem;
    background: linear-gradient(-45deg, #0bd9e7, #363b52, #231c8b, #241b0c);
...
.skill {
    ...
    padding: 10px;
    border-radius: 15px;
    box-shadow: 0px 5px 15px rgba(0, 151, 151, 0.7);
    flex: 1 1 220px;
    max-width: 250px;
...
.skill:hover {
    background-color: rgba(0, 151, 151, 0.9);
    transform: scale(1.05);
    box-shadow: 0px 10px 30px rgba(0, 151, 151, 0.9);
}
